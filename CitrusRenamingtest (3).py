...
#this is for testing the program on mac, as it has a weird file structure
if '.DS_Store' in source_folder_list:
        source_folder_list.remove('.DS_Store')
print("Understood. Here is a list of all the files in the import folder" , source_folder_list)
time.sleep(0.25)
...
try:
    ...
    print(f"File" + {source_directory_folder + "/" + original_name} + " moved to " + {destination_directory_folder + "/" + final_name_output} + '.')
except FileNotFoundError:
    print("Ok you should be good to go. Inform VTR that your video is in playback")
#except FileNotFoundError:
#    print(f"Error: Source file '{source_directory_folder + "/" + original_name}' not found.")
except shutil.Error as e:
    print(f"Error moving file: {e}")
#this is for testing the program on mac, as it has a weird file structure
destination_file_list = os.listdir(destination_directory_folder)
if '.DS_Store' in destination_file_list:
        destination_file_list.remove('.DS_Store')
print("Here is a list of all the files in the export folder" , destination_file_list)
